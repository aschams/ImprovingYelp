...
param_log = {'max_depth': 10, 'eta': .3, 'silent': 1, 'objective': 'multi:softmax', 'num_class' : 2, 'eval_metric' : ['merror']}
...
print("---------------")
print( "Accuracy: "+ str(accuracy_score(model_log_preds, y_test)))
print( "Precision: "+ str(precision_score(model_log_preds, y_test)))
print( "Recall: "+ str(recall_score(model_log_preds, y_test)))
